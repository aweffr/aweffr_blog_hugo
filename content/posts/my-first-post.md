...
- 一些思考: 什么时候要抽象，什么时候要复制粘贴
    - 注：复制粘贴有时也不是坏事，但是到处复制粘贴十恶不赦
- Python Web 开发的一些心得，如何开好Flask和Django的车✌️

- 分享一些看过有意思的 Youtube 上的 Tech Conf
    - 比如 David Beazley 的 Python Concurrency From the Ground Up —— 这个真的碉堡了
      
    - 还有一些Django的实践，PyCon US / DjangoCon 是宝藏
    
    - RN 2018， 2019画的Fabric的大饼，当时多amazing，现在(2020年底)依旧镜花水月 [传送门](https://github.com/react-native-community/discussions-and-proposals/issues/4)
...
一些Zhihu/B站有意思的内容我可能也会搬运过来，做点笔记，写些感想。比如督工的睡前消息，再比如陈欣的一些公开课。
...
按想学的动力排序:
1. [《网络搜索原理》 陈光,北邮](https://www.bilibili.com/video/av67367419/)
2. [iOS cs193p](https://cs193p.sites.stanford.edu/)
3. [ICS, a.k.a. CSAPP](https://ipads.se.sjtu.edu.cn/courses/ics/schedule.shtml)
4. ...还有很多很好的Mooc, 就不列上来了。
